...
OBJS = ft_atoi.o ft_strcat.o ft_strcpy.o ft_strdup.o \
	   ft_strlen.o ft_strncat.o ft_strncpy.o ft_strnlen.o \
	   ft_isalpha.o ft_isdigit.o ft_isalnum.o ft_isascii.o \
	   ft_isprint.o ft_toupper.o ft_tolower.o ft_strcmp.o \
	   ft_strncmp.o ft_memcmp.o ft_memcpy.o ft_memset.o \
	   ft_bzero.o ft_memccpy.o ft_memmove.o ft_strstr.o \
	   ft_putchar.o ft_putstr.o ft_putendl.o ft_putnbr.o \
	   ft_memalloc.o ft_strnew.o ft_putchar_fd.o ft_putstr_fd.o \
	   ft_memchr.o ft_strchr.o ft_strrchr.o ft_strlcat.o \
	   ft_strnstr.o ft_memdel.o ft_strdel.o ft_strclr.o \
	   ft_putendl_fd.o ft_striter.o ft_striteri.o ft_strmap.o \
	   ft_strmapi.o ft_strequ.o ft_strnequ.o ft_putnbr_fd.o \
	   ft_strsub.o ft_strjoin.o ft_strtrim.o ft_itoa.o \
	   ft_islower.o ft_isupper.o ft_isnumber.o ft_isblank.o \
	   ft_strndup.o ft_strsplit.o ft_lstnew.o ft_lstdelone.o \
...
ft_strnlen.o: ft_strnlen.c
	@gcc -c -Wall -Wextra -Werror ft_strnlen.c
...
ft_islower.o: ft_islower.c
	@gcc -c -Wall -Wextra -Werror ft_islower.c
	
ft_isupper.o: ft_isupper.c
	@gcc -c -Wall -Wextra -Werror ft_isupper.c
	
ft_isnumber.o: ft_isnumber.c
	@gcc -c -Wall -Wextra -Werror ft_isnumber.c
	
ft_isblank.o: ft_isblank.c
	@gcc -c -Wall -Wextra -Werror ft_isblank.c
	
ft_strndup.o: ft_strndup.c
	@gcc -c -Wall -Wextra -Werror ft_strndup.c
...
get_next_line.o: get_next_line.c
	@gcc -c -Wall -Wextra -Werror get_next_line.c
